      ...
      <main>
        ...
        <section className="relative py-28 md:py-36 lg:py-40 px-4 overflow-hidden">
          ...
          <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-12 md:gap-20">
            <ScrollReveal variant="slide-left" className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-accent-warm text-accent-warm-foreground hover:bg-accent-warm/90 font-heading font-semibold shadow-lg shadow-accent-warm/20 hover:shadow-accent-warm/30 transition-all duration-300">
                  <Link href="#projects">
                    View Projects
                    <ArrowRight className="h-4 w-4 ml-1" />
                  </Link>
                </Button>
                <Button variant="outline" size="lg" asChild className="hover:border-accent-warm/40 transition-all duration-300">
              ...
              <div className="flex items-center gap-3 mt-10 pt-8 border-t border-border/40">
                ...
                <span className="text-xs text-muted-foreground/50 tracking-wide">Based in Sri Lanka</span>
              </div>
            </ScrollReveal>
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 hidden md:block opacity-0 animate-[fade-in_0.8s_ease-out_1.5s_forwards]">
            <div className="w-10 h-16 rounded-full border-2 border-muted-foreground/20 flex items-center justify-center animate-float">
              <svg className="w-4 h-4 text-muted-foreground/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 5v14" />
          ...
          <div className="container mx-auto max-w-5xl">
            <ScrollReveal>
              <div className="text-center mb-16">
                <p className="text-accent-warm font-heading font-semibold text-xs tracking-[0.2em] uppercase mb-3">Get to Know Me</p>
                <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">About Me</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="mt-10">
                  ...
                  <div className="space-y-5 relative before:absolute before:left-[5px] before:top-3 before:bottom-3 before:w-px before:bg-gradient-to-b before:from-accent-warm before:via-accent-warm/40 before:to-transparent">
                    <div className="relative pl-7">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Software Engineer Intern</p>
                    </div>
                    <div className="relative pl-7">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">B.Sc. Honours in Information Technology | GPA: 3.7</p>
                    </div>
                    <div className="relative pl-7">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Trainee Full Stack Developer</p>
                    </div>
                  </div>
                </div>

                <div className="flex gap-3 mt-10">
                  <Button variant="outline" asChild className="hover:border-accent-warm/40 transition-all duration-300">
                    <Link href="/Pasindu_Induwara_CV.pdf" download>
                      <Download className="h-4 w-4 mr-2" />
                      Download CV
                    </Link>
                  </Button>
                  <Button asChild className="bg-accent-warm text-accent-warm-foreground hover:bg-accent-warm/90 shadow-lg shadow-accent-warm/15 transition-all duration-300">
              ...
              <ScrollReveal variant="slide-right" delay={0.2}>
                ...
                <StaggerContainer className="space-y-7" staggerDelay={0.05}>
                  <StaggerItem>
                    <h4 className="font-heading font-medium text-[11px] text-accent-warm uppercase tracking-[0.15em] mb-3">Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {['HTML', 'CSS', 'JavaScript', 'TypeScript', 'Python', 'Java', 'C/C++', 'SQL'].map(s => (
                        <span key={s} className="px-3 py-1.5 text-xs font-medium rounded-full bg-accent-warm/8 text-accent-warm border border-accent-warm/15 hover:bg-accent-warm/15 hover:border-accent-warm/30 transition-all duration-300 cursor-default">
                          {s}
                        </span>
                      ))}
                    </div>
                  ...
                  <StaggerItem>
                    <h4 className="font-heading font-medium text-[11px] text-accent-warm uppercase tracking-[0.15em] mb-3">Frameworks</h4>
                    <div className="flex flex-wrap gap-2">
                      {['React', 'Next.js', 'Node.js', 'Angular', 'Spring Boot', 'Flutter'].map(s => (
                        <span key={s} className="px-3 py-1.5 text-xs font-medium rounded-full bg-secondary/80 text-secondary-foreground border border-border/60 hover:border-accent-warm/20 hover:bg-accent-warm/5 transition-all duration-300 cursor-default">
                          {s}
                        </span>
                      ))}
                    </div>
                  ...
                  <StaggerItem>
                    <h4 className="font-heading font-medium text-[11px] text-accent-warm uppercase tracking-[0.15em] mb-3">Tools & Platforms</h4>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <StaggerItem>
                    <h4 className="font-heading font-medium text-[11px] text-accent-warm uppercase tracking-[0.15em] mb-3">Web Development</h4>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="mt-10">
                  <h4 className="font-heading font-medium text-[11px] text-accent-warm uppercase tracking-[0.15em] mb-4">Achievements</h4>
                  <div className="space-y-3">
                    <div className="p-4 rounded-xl bg-card border border-border/40 hover:border-accent-warm/20 transition-all duration-300 group">
                      ...
                      <p className="text-xs text-muted-foreground mt-1 group-hover:text-muted-foreground/80 transition-colors">Inter University Export-Oriented Innovation Competition</p>
                    </div>
                    <div className="p-4 rounded-xl bg-card border border-border/40 hover:border-accent-warm/20 transition-all duration-300 group">
                      ...
                      <p className="text-xs text-muted-foreground mt-1 group-hover:text-muted-foreground/80 transition-colors">Ceylon Treasure project</p>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
        ...
        <section id="projects" className="py-28 px-4 relative">
          <div className="container mx-auto max-w-5xl">
            <ScrollReveal>
              <div className="text-center mb-16">
                <p className="text-accent-warm font-heading font-semibold text-xs tracking-[0.2em] uppercase mb-3">My Work</p>
                <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">Featured Projects</h2>
                <div className="mt-4 mx-auto w-12 h-0.5 bg-accent-warm/40 rounded-full" />
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.3}>
              <div className="mt-14 text-center">
                <Button variant="outline" asChild size="lg" className="hover:border-accent-warm/40 transition-all duration-300">
                  <Link href="/projects">
                    View All Projects
                    <ArrowRight className="h-4 w-4 ml-1" />
                  </Link>
        ...
        <section id="blog" className="py-28 px-4 relative">
          ...
          <div className="container mx-auto max-w-5xl">
            <ScrollReveal>
              <div className="text-center mb-16">
                <p className="text-accent-warm font-heading font-semibold text-xs tracking-[0.2em] uppercase mb-3">Insights</p>
                <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">Latest from My Blog</h2>
                <div className="mt-4 mx-auto w-12 h-0.5 bg-accent-warm/40 rounded-full" />
              </div>
            </ScrollReveal>
            <BlogPosts />
          ...
          <div className="container mx-auto max-w-3xl">
            <ScrollReveal>
              <div className="text-center mb-14">
                <p className="text-accent-warm font-heading font-semibold text-xs tracking-[0.2em] uppercase mb-3">Let&apos;s Connect</p>
                <h2 className="text-3xl md:text-4xl font-heading font-bold tracking-tight">Get In Touch</h2>
                <div className="mt-4 mx-auto w-12 h-0.5 bg-accent-warm/40 rounded-full" />
                    ...
                    <ul className="space-y-5">
                      <li className="flex items-start gap-3.5 group">
                        ...
                        <div>
                          ...
                          <a href="tel:+94703477582" className="text-muted-foreground hover:text-accent-warm transition-colors duration-300 text-sm">+94 70 347 7582</a>
                        </div>
                      </li>
                      <li className="flex items-start gap-3.5 group">
                        <div className="mt-0.5 p-2.5 rounded-xl bg-accent-warm/8 text-accent-warm border border-accent-warm/10 group-hover:bg-accent-warm/15 group-hover:border-accent-warm/25 transition-all duration-300">
                        ...
                        <div>
                          ...
                          <a href="mailto:pasindunaduninduwara@gmail.com" className="text-muted-foreground hover:text-accent-warm transition-colors duration-300 text-sm">pasindunaduninduwara@gmail.com</a>
                        </div>
                      </li>
                    </ul>
                  </div>
